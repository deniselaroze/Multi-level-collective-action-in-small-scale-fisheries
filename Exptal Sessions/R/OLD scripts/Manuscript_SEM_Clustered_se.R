...
#T1
save_sem_plot(df, 1, 1, path_github)
save_dynamic_sem_plot(df, 7, 8, path_github)
#T2
save_t2_sem_plot(df, 1, 1, path_github)
save_dynamic_t2_sem_plot(df, 7, 8, path_github)

# Shared Area
#T1
save_sharedarea_sem_plot(df, 1, 1, path_github)
save_sharedarea_dynamic_sem_plot(df,7, 8, path_github)
#T2
save_sharedarea_t2_sem_plot(df, 1, 1, path_github)
save_sharedarea_t2_dynamic_sem_plot(df, 7, 8, path_github)
