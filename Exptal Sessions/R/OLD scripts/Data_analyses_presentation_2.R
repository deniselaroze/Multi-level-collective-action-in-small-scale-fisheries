...
stargazer(lm1, lm2,
          ...
          covariate.labels = c("Mean Compliance by Group (t-1)", "Beliefs Compliance by Ingroup in OA", "Beliefs Compliance by Outsiders in OA", 
...
#######################################
### Beliefs on Trust conflict OA - T2
#######################################
